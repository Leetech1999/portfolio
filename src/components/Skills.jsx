            ...
            <li key={`${ele.lang}-${ele.ability}`}>
              ...
              <div className="ability-bar">
                ...
                <p>
                  ...
                  Recusandae soluta fugiat nam maxime sit laudantium aspernatur
                  expedita sunt saepe, nobis labore doloribus similique quae!
                  Quas doloribus molestiae rem repellendus reiciendis!
                </p>
              </div>
            </li>
          );
